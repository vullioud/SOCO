...
raw_params <- tribble(
  ...
  # --- Shelterwood ---
  "shelterwood",   "execution_schedule", "Production",   "normal",  80,    10,   NA,      NA,     NA,    NA,     NA,     NA,
  ...
  "femel",         "times",              "Production",   "poisson", NA,    NA,   2,       NA,     NA,    NA,     NA,     NA,
  "femel",         "times",              "Biodiversity", "poisson", NA,    NA,   4,       NA,     NA,    NA,     NA,     NA,
  "femel",         "times",              "CO2",          "poisson", NA,    NA,   3,       NA,     NA,    NA,     NA,     NA,
  ...
  "femel",         "initial_size",       "Production",   "poisson", NA,    NA,   1,       NA,     NA,    NA,     NA,     NA,
  "femel",         "initial_size",       "Biodiversity", "poisson", NA,    NA,   1,       NA,     NA,    NA,     NA,     NA,
  "femel",         "initial_size",       "CO2",          "poisson", NA,    NA,   1,       NA,     NA,    NA,     NA,     NA,
  
  "femel",         "growth_width",       "Production",   "poisson", NA,    NA,   1,       NA,     NA,    NA,     NA,     NA,
  "femel",         "growth_width",       "Biodiversity", "poisson", NA,    NA,   1,       NA,     NA,    NA,     NA,     NA,
  "femel",         "growth_width",       "CO2",          "poisson", NA,    NA,   1,       NA,     NA,    NA,     NA,     NA,
  ...
  "targetDBH",     "targetDBH",          "Production",   "normal",  45,    5,    NA,      NA,     NA,    NA,     NA,     NA,
  "targetDBH",     "targetDBH",          "Biodiversity", "normal",  65,    10,   NA,      NA,     NA,    NA,     NA,     NA,
  "targetDBH",     "targetDBH",          "CO2",          "normal",  60,    8,    NA,      NA,     NA,    NA,     NA,     NA,
  
  "targetDBH",     "interval",           "Production",   "poisson", NA,    NA,   5,       NA,     NA,    NA,     NA,     NA,
  "targetDBH",     "interval",           "Biodiversity", "poisson", NA,    NA,   10,      NA,     NA,    NA,     NA,     NA,
  ...
  "plenter_harvest", "execution_schedule", "Production",   "normal",  80,    10,   NA,      NA,     NA,    NA,     NA,     NA,
  "plenter_harvest", "execution_schedule", "Biodiversity", "normal",  80,    10,   NA,      NA,     NA,    NA,     NA,     NA,
  "plenter_harvest", "execution_schedule", "CO2",          "normal",  80,    10,   NA,      NA,     NA,    NA,     NA,     NA,
  ...
  "plenter_thinning", "execution_schedule", "Production",   "normal",  40,    8,    NA,      NA,     NA,    NA,     NA,     NA,
  "plenter_thinning", "execution_schedule", "Biodiversity", "normal",  40,    8,    NA,      NA,     NA,    NA,     NA,     NA,
  "plenter_thinning", "execution_schedule", "CO2",          "normal",  40,    8,    NA,      NA,     NA,    NA,     NA,     NA,
  ...
  "fromBelow",     "execution_schedule", "Production",   "normal",  30,    5,    NA,      NA,     NA,    NA,     NA,     NA,
  ...
  "selectiveThinning", "execution_schedule", "Biodiversity", "normal",  45,    8,    NA,      NA,     NA,    NA,     NA,     NA,
  ...
  # --- Tending ---
  "tending",       "execution_schedule", "Production",   "normal",  15,    3,    NA,      NA,     NA,    NA,     NA,     NA,
  "tending",       "execution_schedule", "Biodiversity", "normal",  20,    5,    NA,      NA,     NA,    NA,     NA,     NA,
  "tending",       "execution_schedule", "CO2",          "normal",  18,    4,    NA,      NA,     NA,    NA,     NA,     NA,
