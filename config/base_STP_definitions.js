// ----- Start of File: config/base_STP_definitions.js (Final Corrected Version) -----
...
function getSpeedFactorFromFlag() {
    if (!stand) return 1.0; // Safety check
    // Read the flag set by the CognitionModule. If not present, default to 1.0.
...
BASE_STP_DEFINITIONS['clearcut_system_noSC'] = {
    ...
    activities: () => {
        ...
        let clearcut = lib.harvest.clearcut({ id: 'LS1Clearcut_noSC', schedule: { minRel: function() { return 0.8 / getSpeedFactorFromFlag(); }, optRel: function() { return 1.0 / getSpeedFactorFromFlag(); }, maxRel: function() { return 1.2 / getSpeedFactorFromFlag(); }, force: true }, sendSignal: 'Clearcut_done', constraint: 'stand.age > 60 && stand.volume > 150' });
...
BASE_STP_DEFINITIONS['clearcut_system_SC'] = {
    ...
    activities: () => {
        ...
        let clearcut = lib.harvest.clearcut({ id: 'LS1Clearcut_SC', schedule: { minRel: function() { return 0.8 / getSpeedFactorFromFlag(); }, optRel: function() { return 1.0 / getSpeedFactorFromFlag(); }, maxRel: function() { return 1.2 / getSpeedFactorFromFlag(); }, force: true }, sendSignal: 'Clearcut_done', constraint: 'stand.age > 60 && stand.volume > 150' });
...
BASE_STP_DEFINITIONS['shelterwood_system_noSC'] = {
    ...
    activities: () => {
        ...
        let shelterwood = lib.harvest.shelterwood({ id: 'LS2Shelterwood_noSC', schedule: { minRel: function() { return 0.8 / getSpeedFactorFromFlag(); }, optRel: function() { return 0.9 / getSpeedFactorFromFlag(); }, maxRel: function() { return 200 / getSpeedFactorFromFlag(); }, force: true }, interval: function() { return Math.round(5 / getSpeedFactorFromFlag()); }, times: function() { return Math.round(3 * getSpeedFactorFromFlag()); }, internalSignal: 'Shelterwood_remove', constraint: 'stand.age > 70 && stand.volume > 180' });
...
BASE_STP_DEFINITIONS['shelterwood_system_SC'] = {
    ...
    activities: () => {
        ...
        let shelterwood = lib.harvest.shelterwood({ id: 'LS2Shelterwood_SC', schedule: { minRel: function() { return 0.8 / getSpeedFactorFromFlag(); }, optRel: function() { return 0.9 / getSpeedFactorFromFlag(); }, maxRel: function() { return 200 / getSpeedFactorFromFlag(); }, force: true }, interval: function() { return Math.round(5 / getSpeedFactorFromFlag()); }, times: function() { return Math.round(3 * getSpeedFactorFromFlag()); }, speciesSelectivity: dynamicTendingSelectivity, internalSignal: 'Shelterwood_remove', constraint: 'stand.age > 70 && stand.volume > 180' });
...
BASE_STP_DEFINITIONS['femel_system_noSC'] = {
    ...
    activities: () => {
        ...
        selectPatches.constraint = 'stand.age > 80 && stand.volume > 200';
